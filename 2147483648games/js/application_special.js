...
function alwaysTwo() {
  changeRule(function() { return 16; }, normalMerge, normalWin);
}
...
function fibonacci() {
  ...
  changeRule(function() { return Math.Random() < 0.5 ? 8 : 13; },
    function(a, b) {
...
function threes() {
  changeRule(function() { return Math.random() < 0.7 ? (Math.random() < 0.5 ? 12 : 24) : 48; },
...
function tileZero() {
  changeRule(function() {
    return Math.random() < 0.7 ? (Math.random() < 0.5 ? 32 : 64) : 0;
  }, normalMerge, normalWin);
}

function tileNegative() {
  changeRule(function() { return Math.random() < 0.5 ? 64 : -64; }, 
